...
<html>  
 ...
 <body>  
   ...
   <table>  
     <tr>  
       <th>用户名：</th>  
        <td><input type="text" name="username" value="输入20个字符以内" maxlength = "20" onfocus = "if(this.value == '输入20个字符以内') this.value =''"></td>  
     </tr>  
      <tr>  
        <th>输入密码：</th>  
     ...
     <tr>  
        <td colspan = "2" align = "center">  
         ...
         <input type="reset" value="刷新" onclick = "window.location.href('register.jsp')">  
       </td>  
     </tr>  
   </table>  
    </form>  
